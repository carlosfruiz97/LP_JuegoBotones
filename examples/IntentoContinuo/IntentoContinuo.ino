...
unsigned int ButtonSequence[LP_MAXSEQ] = {3, 2, 1, 0}; // id=0:(seq_len-1)
  //-OPCIONALES
  bool intento_continuo = true; // defecto: true
...
void setup()
{
  ...
  // -- Juego Botones: Intento Continuo --
...
void loop()
{
   ...
   * Devuelve:
   *  En el caso de INTENTO CONTINUO:   (intento_continuo = true)
  ...
  if (juego_estado <= LP_APRETADO_NO_SOL){
    ...
    // Si Solucionado: Mantener Encendido y Reset
